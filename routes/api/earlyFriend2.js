...
router.route("/")
  .post((req, res) => {
    const name = req.body.earlyFriendName2;
    const email = req.body.earlyFriendEmail2;
    const friendName = req.body.nameEarly
...
function emailOptions(name, email, friendName) {
  console.log("from early email options friend 2")
  let emailOptions = {}
